                    ...
                    <div class="bg-white p-7 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden">
                        ...
                        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 relative z-10">
                            ...
                            <div class="relative w-24 h-24 shrink-0">
                                <img src="https://i.pravatar.cc/150?img=47" alt="Admin Profile" class="w-full h-full rounded-full object-cover border-4 border-white shadow-sm">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" value="Olivia Rodrigo" class="w-full bg-slate-100 border-none rounded-xl py-3.5 px-4 text-sm font-semibold text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#1D5D8A] transition">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="w-full bg-slate-100 rounded-xl flex items-center px-4 focus-within:ring-2 focus-within:ring-[#1D5D8A] transition overflow-hidden">
                                    ...
                                    <input type="text" value="Washly Premium Laundry" class="w-full bg-transparent border-none py-3.5 pl-4 pr-0 text-sm font-semibold text-gray-700 focus:outline-none focus:ring-0">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="w-full bg-slate-100 rounded-xl flex items-center px-4 py-3.5 focus-within:ring-2 focus-within:ring-[#1D5D8A] transition overflow-hidden">
                                    ...
                                    <textarea rows="2" class="w-full bg-transparent border-none p-0 pl-4 text-sm font-semibold text-gray-700 focus:outline-none focus:ring-0 resize-none">Jl. Tamansiswa No. 99, Sekaran.</textarea>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-full bg-slate-100 rounded-xl flex items-center px-4 focus-within:ring-2 focus-within:ring-[#1D5D8A] transition overflow-hidden flex-1">
                                        ...
                                        <input type="time" value="08:00" class="w-full bg-transparent border-none py-3.5 pl-4 pr-0 text-sm font-semibold text-gray-700 focus:outline-none focus:ring-0 cursor-pointer">
                                    </div>
                                    <span class="text-xs font-bold text-gray-400">hingga</span>
                                    <div class="w-full bg-slate-100 rounded-xl flex items-center px-4 focus-within:ring-2 focus-within:ring-[#1D5D8A] transition overflow-hidden flex-1">
                                        <i class="far fa-clock text-gray-400 shrink-0"></i>
                                        <input type="time" value="21:00" class="w-full bg-transparent border-none py-3.5 pl-4 pr-0 text-sm font-semibold text-gray-700 focus:outline-none focus:ring-0 cursor-pointer">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5 flex-1">
                            ...
                            <div>
                                ...
                                <div class="flex items-center bg-white rounded-xl px-4 py-3 shadow-sm focus-within:ring-2 focus-within:ring-[#1D5D8A] transition">
                                    ...
                                    <input type="text" value="6000" class="bg-transparent border-none w-full font-bold text-gray-700 text-sm focus:outline-none p-0 m-0">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center bg-white rounded-xl px-4 py-3 shadow-sm focus-within:ring-2 focus-within:ring-[#1D5D8A] transition">
                                    <span class="text-gray-400 font-bold mr-2 text-sm">Rp</span>
                                    <input type="text" value="5000" class="bg-transparent border-none w-full font-bold text-gray-700 text-sm focus:outline-none p-0 m-0">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center bg-white rounded-xl px-4 py-3 shadow-sm focus-within:ring-2 focus-within:ring-[#1D5D8A] transition">
                                    <span class="text-gray-400 font-bold mr-2 text-sm">Rp</span>
                                    <input type="text" value="10000" class="bg-transparent border-none w-full font-bold text-gray-700 text-sm focus:outline-none p-0 m-0">
                                </div>
                            </div>

                            {{-- Ongkir Flat --}}
                            <div class="pt-4 border-t border-slate-200 mt-2">
                                <label class="block text-[11px] font-bold text-gray-500 mb-2">Ongkir Flat (Delivery)</label>
                                <div class="flex items-center justify-between bg-white rounded-xl px-4 py-3 shadow-sm focus-within:ring-2 focus-within:ring-[#1D5D8A] transition">
                                    <div class="flex items-center flex-1">
                                        <span class="text-gray-400 font-bold mr-2 text-sm">Rp</span>
                                        <input type="text" value="15000" class="bg-transparent border-none w-full font-bold text-gray-700 text-sm focus:outline-none p-0 m-0">
                                    </div>
