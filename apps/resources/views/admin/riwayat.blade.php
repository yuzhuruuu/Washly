...
<body class="bg-[#F8FAFC] h-screen font-sans text-slate-800 flex overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col h-full shrink-0 relative z-20">
        ...
        {{-- Menu Navigasi (SINKRON ROUTE LARAVEL) --}}
        <nav class="flex-1 px-4 space-y-1">
            ...
            <a href="{{ route('admin.riwayat') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition" style="background-color: #EFF6FF; color: #1D5D8A;">
    ...
    <main class="flex-1 overflow-y-auto relative z-10">
        ...
        <div class="p-10 max-w-6xl mx-auto relative z-10">
            ...
            {{-- 3 SUMMARY CARDS (SINKRON DATABASE) --}}
            ...
            {{-- TABEL RIWAYAT (SINKRON DATABASE) --}}
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <tbody class="text-sm font-medium">
                            ...
                            @forelse($riwayatPesanan ?? [] as $pesanan)
                                @php
                                    ...
                                    // Waktu Update Terakhir (Untuk Tanggal Selesai/Batal)
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition">
                                    ...
                                    {{-- Coret Harga Jika Pesanan Dibatalkan --}}
                ...
                {{-- Pagination Footer (SINKRON VARIABEL) --}}
                <div class="px-6 py-4 border-t border-gray-100 flex justify-between items-center bg-white">
                    ...
                    {{-- Pagination Laravel Built-in (jika menggunakan paginate() di controller) --}}
                    @if(isset($riwayatPesanan) && $riwayatPesanan->hasPages())
                        <div class="flex gap-1 items-center">
                            {{-- Jika kamu ingin memunculkan tombol default Tailwind Laravel, bisa gunakan perintah: --}}
                            {{-- $riwayatPesanan->links('vendor.pagination.tailwind') --}}
                            
                            {{-- Tapi karena harus 100% desain asli, ini logika HTML aslimu yang diaktifkan dengan Prev/Next: --}}
