...
<body class="bg-[#F8FAFC] min-h-screen font-sans text-slate-800 pb-12 antialiased relative overflow-x-hidden">
    ...
    <nav class="bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center relative">
            ...
            <div class="hidden md:flex space-x-10 text-sm font-semibold absolute left-1/2 -translate-x-1/2">
                <a href="#" class="text-gray-400 hover:text-gray-600 transition">Beranda</a>
            ...
            <div class="flex items-center space-x-5">
                <span class="text-sm text-gray-500 font-medium">Halo, {{ Auth::guard('pelanggan')->user()?->nama ?? 'Asha' }}!</span>
                ...
                <div class="w-8 h-8 rounded-full bg-gray-200 overflow-hidden border border-gray-300 shadow-inner">
                    <img src="https://ui-avatars.com/api/?name=Asha&background=0074A6&color=fff" alt="Avatar" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </nav>
    ...
    <main class="max-w-5xl mx-auto px-6 mt-12 relative z-10"
        ...
        <div class="flex items-center gap-5 mb-8">
            <a href="{{ url('/dashboard/pelanggan') }}" class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm text-gray-600 hover:bg-gray-50 transition border border-gray-100">
        ...
        <div class="bg-white rounded-[2rem] p-10 shadow-sm border border-gray-50 mb-8">
            <div class="flex justify-between items-start mb-12">
                <div>
                    ...
                    <h2 class="text-3xl font-extrabold text-gray-800 tracking-tight">WS-2024-088</h2>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-2xl p-4 flex items-center gap-4 shadow-sm border border-gray-50 mb-6">
                    ...
                    <div>
                        <p class="font-bold text-gray-800 text-sm">Cuci Komplit (Reguler)</p>
                        <p class="text-xs text-gray-500">Cuci, Kering, Setrika</p>
                    </div>
                </div>
                <div class="space-y-4">
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        <span class="text-sm text-gray-500">Berat Aktual</span>
                        <span class="text-sm font-bold text-gray-800">3.5 Kg</span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        <span class="text-sm text-gray-500">Tanggal Selesai (Est)</span>
                        <span class="text-sm font-bold text-gray-800">Besok, 14:00</span>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                ...
                <div x-show="step > 0" class="bg-gradient-to-br from-[#E0FCFE] to-[#D0F4F8] border border-cyan-100 rounded-2xl p-6 shadow-sm">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="font-bold text-[#005B82] text-lg leading-tight">Pembayaran Berhasil!</h3>
                    </div>
        ...
        <div class="text-center mt-16 mb-8">
            <a href="#" class="text-[#0074A6] hover:text-blue-800 font-bold text-sm flex justify-center items-center gap-2 transition">
                <i class="fas fa-headset"></i> Hubungi Admin
            </a>
        </div>

        <div class="fixed bottom-6 right-6 bg-white p-4 rounded-xl shadow-2xl border-2 border-dashed border-gray-300 z-50 flex flex-col items-center">
            <p class="text-[10px] font-bold text-gray-500 mb-2">🕹️ SIMULATOR</p>
            <div class="flex gap-2">
                <button @click="if(step > 0) step--" class="w-8 h-8 bg-gray-100 rounded flex items-center justify-center font-bold hover:bg-gray-200">-</button>
                <div class="w-8 h-8 bg-blue-50 text-blue-600 font-bold flex items-center justify-center rounded" x-text="step"></div>
                <button @click="if(step < 5) step++" class="w-8 h-8 bg-gray-100 rounded flex items-center justify-center font-bold hover:bg-gray-200">+</button>
            </div>
        </div>
    </main>
</body>
